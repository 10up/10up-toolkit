...
module.exports = {
	meta: {
		...
		schema: [],
		messages: {
			noFlankingWhitespace: 'Translations should not contain flanking whitespace{{problem}}',
		},
		fixable: 'code',
	},
	create(context) {
		return {
			CallExpression(node) {
				...
				for (const arg of candidates) {
					...
					const problem = PROBLEMS_BY_CHAR_CODE[trimmableWhitespace[0].charCodeAt(0)];
