...
var _jestWorker = __nccwpck_require__(9168);
...
var _FifoQueue = _interopRequireDefault(__nccwpck_require__(9608));

var _types = __nccwpck_require__(7873);
...
var _BaseWorkerPool = _interopRequireDefault(__nccwpck_require__(8019));
...
class WorkerPool extends _BaseWorkerPool.default {
  ...
  createWorker(workerOptions) {
    ...
    if (this._options.enableWorkerThreads && canUseWorkerThreads()) {
      Worker = __nccwpck_require__(8882)/* .default */ .Z;
    } else {
      Worker = __nccwpck_require__(4472)/* .default */ .Z;
    }
...
function _types() {
  const data = __nccwpck_require__(7873);
...
var _Farm = _interopRequireDefault(__nccwpck_require__(5832));

var _WorkerPool = _interopRequireDefault(__nccwpck_require__(8377));

var _PriorityQueue = _interopRequireDefault(__nccwpck_require__(9425));

var _FifoQueue = _interopRequireDefault(__nccwpck_require__(9608));

var _messageParent = _interopRequireDefault(__nccwpck_require__(156));
...
function _supportsColor() {
  const data = __nccwpck_require__(5274);
...
const hasFlag = __nccwpck_require__(875);
