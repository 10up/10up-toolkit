...
const chalk2 = __nccwpck_require__(588);
...
const makeDynamicStyles = (wrap, targetSpace, identity, isBackground) => {
	if (colorConvert === undefined) {
		colorConvert = __nccwpck_require__(750);
	}
...
const ansiStyles = __nccwpck_require__(793);
const {stdout: stdoutColor, stderr: stderrColor} = __nccwpck_require__(392);
const {
	stringReplaceAll,
...
const chalkTag = (chalk, ...strings) => {
	...
	if (template === undefined) {
		template = __nccwpck_require__(818);
	}
...
const cssKeywords = __nccwpck_require__(61);
...
const conversions = __nccwpck_require__(900);
const route = __nccwpck_require__(928);
...
const hasFlag = __nccwpck_require__(976);
